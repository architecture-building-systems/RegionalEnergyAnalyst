...
def main(Xy_training_path, output_trace_path, response_variable, predictor_variables, cities, samples, scaler_type):
    ...
    with pm.Model() as hierarchical_model:
        ...
        degree_m_sd = pm.HalfNormal('degree_m_sd', sd=5, shape=degree_count)
        ...
        degree_g = pm.Normal("degree_g", mu=global_g, sd=global_g_sd, shape=degree_count)
        ...
        degree_state_g = pm.Normal('degree_state_g', mu=degree_g[degree_state_indexes], sd=degree_g_sd[degree_state_indexes], shape=degree_state_count)
        ...
        degree_state_county_g = pm.Normal('degree_state_county_g', mu=degree_state_g[degree_state_county_indexes], sd=degree_state_g_sd[degree_state_county_indexes], shape=degree_state_county_count)
    ...
    with hierarchical_model:
        ...
        # # plt.show()
        hierarchical_trace = pm.sample(draws=samples, tune=1000, cores=2, nuts_kwargs=dict(target_accept=0.95))
