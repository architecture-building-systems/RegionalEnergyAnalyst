...
import numpy as np
from configuration import CONFIG_FILE,  DATA_TRAINING_FILE

data_path = DATA_TRAINING_FILE
...
df["eHDD_FLOOR_18_5_C_m2"] = np.exp(df["HDD_FLOOR_18_5_C_m2"].values)
sns.pairplot(df, x_vars=["SITE_ENERGY_MWh_yr", "LOG_HDD_FLOOR_18_5_C_m2", "LOG_CDD_FLOOR_18_5_C_m2"],
                 y_vars=["SITE_ENERGY_MWh_yr", "LOG_HDD_FLOOR_18_5_C_m2", "LOG_CDD_FLOOR_18_5_C_m2"],
                    size=4, aspect=1,
                         hue="BUILDING_CLASS",
                         markers="+", plot_kws = dict(s=50, edgecolor="b", linewidth=1), diag_kws = dict(bins=224),
                         palette="PuBuGn_d")
