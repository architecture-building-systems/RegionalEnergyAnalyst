...
DATA_RAW_BUILDING_IPCC_SCENARIOS_ENTHALPY_FILE = os.path.join(os.path.abspath(os.path.dirname(__file__)), "data_raw", "IPCC_SCENARIOS", "data", "future_enthalpy_days.csv")
